...
public class FourDaysAgoFragment extends Fragment implements Runnable{
    ...
    private HashMap<String, String> selectData() {
        if(TodayGroupFragment.sevenDaysOfARequest != null)
            return new HashMap<>(Objects.requireNonNull(TodayGroupFragment.sevenDaysOfARequest.get(DAYFOUR)));
        else if(TodayGroupSubFragment.sevenDaysOfARequest != null)
            return new HashMap<>(Objects.requireNonNull(TodayGroupSubFragment.sevenDaysOfARequest.get(DAYFOUR)));
        else if(TodaySingleUserFragment.sevenDaysOfARequest != null)
            return new HashMap<>(Objects.requireNonNull(TodaySingleUserFragment.sevenDaysOfARequest.get(DAYFOUR)));
        else if(TodaySingleSubUserFragment.sevenDaysOfARequest != null)
            return new HashMap<>(Objects.requireNonNull(TodaySingleSubUserFragment.sevenDaysOfARequest.get(DAYFOUR)));
        else
            return null;
    }
