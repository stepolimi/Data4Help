...
import com.data4help.d4h_thirdparty.fragment.showgroupdatapagerfragment.TodayGroupFragment;
...
public class ShowGroupDataPagerViewAdapter extends FragmentPagerAdapter {

    ShowGroupDataPagerViewAdapter(FragmentManager fm) {
        super(fm);
    }
