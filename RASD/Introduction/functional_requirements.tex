...
\begin{itemize}
	...
	\item[${\textbf{[G4]}}$] {\textbf{Allows the user to accept or not to let a third party to have access to his/her data.}
		\begin{itemize}	
			\item[$\textbf{[R9]}$] {A user is notified when a third party makes a request to have access to the user's data.}
	...
	\item[${\textbf{[G5]}}$] {\textbf{Allows third party to subscribe for new data.}
		\begin{itemize}
			...
			\item[$\textbf{[R12]}$] {A user is notified when a third party decides to subscribe for his data.}
	...
	\item[${\textbf{[G6]}}$] {\textbf{Allows third party to obtain the required data if the request has been accepted, a notification if it has been refused.}
		\begin{itemize}
			\item[$\textbf{[R14]}$] {Third parties receive personal data of users through the given e-mail.}
		\end{itemize}}
	...
	\item[${\textbf{[G7]}}$] {\textbf{Allows an unhealty user to receive quick help.}
		\begin{itemize}
			\item[$\textbf{[D5]}$] {There is an SOS service that has the capability to receive emergency calls by ASOS.
				...
				\end{itemize}}
			\item[$\textbf{[R15]}$] {ASOS is able to contact the SOS service in case of the rise of an unhealty user in 5s.}
			\item[$\textbf{[R16]}$] {ASOS is able to send to the SOS service the unhealty user's data and personal data.}
		\end{itemize}}
