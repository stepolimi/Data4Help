...
\begin{itemize}
	...
	\item[${\textbf{[G7]}}$] {Allows users to monitor their healt parameters.}
	\item[${\textbf{[G8]}}$] {Allows users to activate or deactivate the \hbox{\emph{ASOS}} service on top of \hbox{\emph{D4H}}.}
