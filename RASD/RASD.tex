...
\begin{document}
	...
	\input{./Introduction/doc_structure.tex}
	...
	\input{./Specific_Requirements/attributes.tex}
	...
	\section{Alloy Model}
	\input{./Alloy_Appendix/alloy_model.tex}
	\lstinputlisting[language=alloy]{./Alloy_Appendix/alloy.tex}
	\input{./Alloy_Appendix/alloy_results_and_world.tex}

	%Appendix
	\appendix
	\chapter{Appendix}
	
	\input{./Alloy_Appendix/appendix.tex}
