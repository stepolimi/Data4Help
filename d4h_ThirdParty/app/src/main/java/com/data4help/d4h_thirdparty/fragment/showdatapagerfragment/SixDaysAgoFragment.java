...
import static com.data4help.d4h_thirdparty.Config.DAYSEVEN;
...
public class SixDaysAgoFragment extends Fragment implements Runnable{
    ...
    private void setHealthParameters() {
        HashMap<String,String> data = new HashMap<>(Objects.requireNonNull(TodayFragment.sevenDaysOfARequest.get(DAYSEVEN)));
