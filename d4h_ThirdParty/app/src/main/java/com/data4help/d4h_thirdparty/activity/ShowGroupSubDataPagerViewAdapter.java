...
import com.data4help.d4h_thirdparty.fragment.showgroupdatapagerfragment.TodayGroupSubFragment;
...
public class ShowGroupSubDataPagerViewAdapter  extends FragmentPagerAdapter {

    ShowGroupSubDataPagerViewAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int i) {
        switch (i){
            case 0:
                return new TodayGroupSubFragment();
            case 1:
