...
import com.data4help.d4h_thirdparty.fragment.showgroupdatapagerfragment.TodaySingleSubUserFragment;
...
public class ShowSingleSubUserDataPagerViewAdapter  extends FragmentPagerAdapter {

    ShowSingleSubUserDataPagerViewAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int i) {
        switch (i){
            case 0:
                return new TodaySingleSubUserFragment();
            case 1:
